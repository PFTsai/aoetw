    ...
    <div class="row padtop">
      ...
      <div class="col-md-8">
        <div class="n1">
          ...
          <p>
            在遊戲裡只佔半個人口的單位，是兼具便宜和快速的單位，缺點是過於脆弱。
          </p>
        </div>
        <h3>戰術</h3>
        <div class="hrn1"></div>
        <div class="n1">
          ...
          <p>
            他也是騷擾戰術中很優質的選擇，一群爪刀勇士可以擊殺沒有保護的<nuxt-link
              to="/units/Villager"
              >村民</nuxt-link
            >或破壞重要據點(精英有對<nuxt-link to="/building">建築</nuxt-link
            >而外傷害)。另外爪刀勇士因為可以快速海量產出，因此可以用來閃電攻擊或者是快速集結保護自家城鎮據點。
          </p>
          <p>
          ...
          <ul>
            ...
            <li>
              <nuxt-link to="/civs/Goths">哥德</nuxt-link>：研發<nuxt-link
                to="/techs"
                >科技</nuxt-link
              >追蹤技術、<nuxt-link to="/techs/Squires">護衛技術</nuxt-link
